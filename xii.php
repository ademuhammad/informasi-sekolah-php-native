...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <button type="button" class="btn btn-info mt-3"> <a href="tambah12.php"> Tambah Siswa </a></button>
            </div>
            ...
            ?>
            <div class="container">
                <h3 class="text-center mt-3"> Daftar Siswa Kelas XII SMA NEGERI 10 SEMITAU </h3>
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($queryxii as $row) : ?>
                        <tr>
                            ...
                            <td> <?= $row["alamat"]; ?></td>
                            <td>
                                <a href="edit12.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-warning">EDIT</a>
                                <a href="hapusxii.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-danger" onclick=" return confirm('yakin ingin hapus?');">HAPUS</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <div class="container">
                <button type="button" class="btn btn-info mt-3"> <a href="cetakxii.php"> CETAK </a></button>
            </div>
