...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- button tambah data -->
            <div class="container">
                <button type="button" class="btn btn-info mt-3"> <a href="tambahguru.php"> Tambah Guru </a></button>
            </div>

            <!-- form tampil data -->
            <?php
            require 'koneksi.php';
            $queryguru = mysqli_query( $link,"SELECT * FROM guru");


            ?>
            <div class="container">
                <h1 class="text-center"> Daftar Guru SMA NEGERI 10 SEMITAU </h1>
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($queryguru as $row) : ?>
                        <tr>
                            ...
                            <td> <?= $row["alamat"]; ?></td>
                            <td>
                                <a href="editguru.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-warning">EDIT</a>
                                <a href="hapusguru.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-danger" onclick=" return confirm('yakin ingin hapus?');">HAPUS</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
