...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <button type="button" class="btn btn-info mt-3"> <a href="tambah10.php"> Tambah Siswa </a></button>
            </div>
            ...
            ?>
            <div class="container">
                <h3 class="text-center mt-3"> Daftar Siswa Kelas X SMA NEGERI 10 SEMITAU </h3>
                ...
                <table class="table table-striped">
                    ...
                    <?php foreach ($queryx as $row) : ?>
                        <tr>
                            ...
                            <td> <?= $row["alamat"]; ?></td>
                            <td>
                                <a href="edit10.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-warning">EDIT</a>
                                <a href="hapusx.php?id=<?= $row["id"]; ?>" class="btn btn-sm btn-danger" onclick=" return confirm('yakin ingin hapus?');">HAPUS</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
            ...
            <div class="container">
                <button type="button" class="btn btn-info mt-3"> <a href="cetakx.php"> CETAK </a></button>
            </div>
